...
<div class"row">
	<div class="col-md-12">
		<form class="form-horizontal" id="mk-filter" id="mk-filter" method="post">
			...
			<div class='form-group'>
				...
				<div class="col-md-4">
					...
					echo form_dropdown('thn_ajaran', $optionta, '', $js);
					?>
				</div>
			</div>
			<div class='form-group'>
				...
				<div class="col-md-3">
					<?php 
					$optionsmt=array("all"=>"Semua Data","GAS"=>"Ganjil","GEN"=>"Genap");
					$js='id="smt" class="form-control"';
					echo form_dropdown('smt', $optionsmt, '', $js);
					?>
				</div>
			</div>
			<div class='form-group'>
